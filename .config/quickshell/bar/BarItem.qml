...
Item {
    ...
    // Default to on_surface for text
    property color textColor: Colors.on_surface
    property color iconColor: root.textColor
    property int borderWidth: 1
    // Default background to surface_container
    property color bgColor: Colors.surface_container
    // Default border to outline with 0 alpha
    property color borderColor: Qt.rgba(Colors.outline.r, Colors.outline.g, Colors.outline.b, 0)

    // Spotlight Color- Dynamic, based on on_surface
    property color hoverColor: Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.14)
...
Rectangle {
    ...
    Behavior on opacity { NumberAnimation { duration: 120; easing.type: Easing.OutCubic } }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.5; color: Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.18) }
    ...
    Rectangle {
        ...
        border.color: hover.hovered
                     ? Qt.rgba(Colors.outline.r, Colors.outline.g, Colors.outline.b, 0.20)
                     : root.borderColor
