...
Item {
    ...
    // Use colors.js palette as the base; fall back to Theme/theme if needed
    readonly property color _textPrimary: theme ? theme.textPrimary : Colors.on_surface
    readonly property color _outline: theme && theme.outline !== undefined ? theme.outline : Qt.rgba(Colors.outline.r, Colors.outline.g, Colors.outline.b, 0.10)
    readonly property color _subtleFill: theme && theme.subtleFill !== undefined ? theme.subtleFill : Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.05)
    readonly property color _subtleFillHover: theme && theme.subtleFillHover !== undefined ? theme.subtleFillHover : Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.15)

    readonly property color _accentRed: _isDark ? Colors.error : (_hasTheme && theme.accentRed !== undefined ? theme.accentRed : Colors.error)
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            (root._isDark ? Colors.on_primary_container : Colors.on_primary) :
