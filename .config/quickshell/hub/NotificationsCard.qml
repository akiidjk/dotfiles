...
Lib.Card {
  ...
  readonly property color cFgMain: isDarkMode ? Colors.on_surface : Colors.on_surface
  readonly property color cFgMuted: isDarkMode ? Colors.on_surface_variant : Colors.on_surface_variant
  readonly property color cBgItem: isDarkMode ? Colors.surface_container_high : Colors.surface_container
  readonly property color cAccent: isDarkMode ? Colors.primary : Colors.primary

  readonly property color cSoftBtn: (!hasTheme || isDarkMode)
      ? Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.04)
      : root.theme.subtleFill
  readonly property color cSoftBtnHover: (!hasTheme || isDarkMode)
      ? Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.08)
      : root.theme.subtleFillHover

  readonly property color cItemHoverOverlay: (!hasTheme || isDarkMode)
      ? Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.08)
      : root.theme.hoverSpotlight
  readonly property color cRipple: (!hasTheme || isDarkMode)
      ? Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.15)
      : root.theme.hoverSpotlight
  readonly property color cIconBg: (!hasTheme || isDarkMode)
      ? Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.05)
      : root.theme.subtleFill
  readonly property color cOvershoot: (!hasTheme || isDarkMode)
      ? Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.10)
      : root.theme.hoverSpotlight
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      Rectangle {
        ...
        implicitHeight: 26
        implicitWidth: 56
        color: (!hasTheme || isDarkMode)
                ? Qt.rgba(Colors.error_container.r, Colors.error_container.g, Colors.error_container.b, 0.10)
                : Qt.rgba(Colors.error_container.r, Colors.error_container.g, Colors.error_container.b, 0.10)


        Rectangle {
          anchors.fill: parent; radius: parent.radius
          color: Qt.rgba(Colors.error_container.r, Colors.error_container.g, Colors.error_container.b, 0.15)
        ...
        Text {
          ...
          font.pixelSize: 10
          font.weight: 700
          color: (!hasTheme || isDarkMode) ? Colors.error : Colors.error
        }
