...
FocusScope {
    ...
    // Theme colors
        ...
        readonly property color cText: theme ? theme.textPrimary : Colors.on_surface
        readonly property color cSubtle: theme ? theme.subtleFill : Colors.surface_container_low
        readonly property color cHoverFill: theme ? theme.subtleFillHover : Qt.rgba(Colors.on_surface.r, Colors.on_surface.g, Colors.on_surface.b, 0.12)
    readonly property color cActive: isDark
        ? (theme ? theme.accent : Colors.primary)
        : Colors.secondary_container
        readonly property color cDanger: (theme && theme.accentRed !== undefined) ? theme.accentRed : Colors.error
