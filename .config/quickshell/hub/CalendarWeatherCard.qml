...
Lib.Card {
    ...
    Lib.CommandPoll {
        ...
        running: root.active && root.visible
        interval: 60000
        command: ["bash", "-lc", "$HOME/.config/quickshell/lib/weather.sh"]
        parse: function (out) {
            try {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        font.pixelSize: 10
                        color: ((root.theme && root.theme.accentBlue !== undefined) ? root.theme.accentBlue : Colors.secondary)
                    }
                    ...
                    Text {
                        ...
                        font.pixelSize: 11
                        font.weight: 600
                        color: (root.theme ? root.theme.textSecondary : Colors.on_secondary)
            ...
            ColumnLayout {
                ...
                Text {
                    ...
                    font.pixelSize: 11
                    font.weight: 800
                    color: (root.theme ? root.theme.accent : Colors.secondary)
        ...
        ColumnLayout {
            ...
            Rectangle {
                Layout.fillWidth: true
                height: 1
                color: Qt.rgba(Colors.outline_variant.r, Colors.outline_variant.g, Colors.outline_variant.b, 0.6)
            }
