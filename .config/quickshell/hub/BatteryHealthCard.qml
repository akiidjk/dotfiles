...
Lib.Card {
    ...
    readonly property color accent: themed ? root.theme.accent : Colors.primary
    readonly property color accentAlt: themed ? root.theme.accentSlider : Colors.secondary
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                height: 7
                radius: 4
                color: themed ? root.theme.bgItem : Colors.surface_variant
