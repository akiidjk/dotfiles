...
Item {
    ...
    property color accentColor: (root.theme ? (root.theme.accentSlider !== undefined ? root.theme.accentSlider : root.theme.accent) : Colors.Primary)
    ...
    Slider {
        ...
        background: Rectangle {
            ...
            // Track Color
            color: (root.theme ? root.theme.bgItem : Colors.surface_container_highest)
            ...
            Text {
                ...
                color: slider.visualPosition > 0.15 ? (root.theme ? root.theme.textOnAccent : Colors.on_primary) : (root.theme ? root.theme.textSecondary : Colors.on_secondary)
                Behavior on color {
                    ColorAnimation {
                        duration: 200
                    }
