...
Item {
    ...
    readonly property color cSurfaceVar: "#4c4546"
    readonly property color cPrimary: "#c6c6c6"
    readonly property color cOnPrimary: "#303030"
    readonly property color cText: "#e2e2e2"
    ...
    function username() {
        return userSelector.currentText || "";
    }

    function avatarCandidate(i) {
        var u = username();
        if (i === 0)
            return toFileUrl("/usr/share/sddm/faces/" + u + ".face.icon");
        if (i === 1)
            return toFileUrl("/var/lib/AccountsService/icons/" + u);
        return "";
    }
    ...
    function attemptLogin() {
        ...
        if (sessionIdx < 0)
            sessionIdx = (root.currentSessionIndex >= 0) ? root.currentSessionIndex : 0;
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    Layout.alignment: Qt.AlignHCenter
                    implicitWidth: sessionLabel.contentWidth + 24
                    implicitHeight: 26
                    radius: 8
                    color: root.cSurfaceVar
                    Text {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        PixelDots {
                            anchors.centerIn: parent
                            dotCount: passwordInput.text.length
                            dotColor: root.cText
                            animColor: root.cPrimary
                        }
                        TextInput {
                            id: passwordInput
                            anchors.fill: parent
                            ...
                            Keys.onPressed: {
                                if (event.key === Qt.Key_Down && root.sessionOpen)
                                    sessionList.forceActiveFocus();
                            }
                        }
                        Text {
        ...
        Rectangle {
            ...
            ListView {
                ...
                Keys.onReturnPressed: {
                    root.currentSessionIndex = currentIndex;
                    sessionSelector.currentIndex = currentIndex;
                    root.sessionOpen = false;
                    passwordInput.forceActiveFocus();
                }
